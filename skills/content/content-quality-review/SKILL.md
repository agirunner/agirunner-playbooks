...
description: Use when drafted documentation or content needs an editorial review for audience fit, clarity, factual support, and consistency.
---

# Content Quality Review

## Purpose
Review content from the reader’s perspective and separate blocking issues
from polish.

## Use When
- docs or content are ready for editorial review
- accuracy and clarity both matter
- multiple contributors created inconsistent drafts
